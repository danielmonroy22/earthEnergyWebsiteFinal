            ...
            <div id="residential" className='papa h-screen flex flex-col-reverse  md:flex-row  '>
                <div className=' md:w-[30%] w-full md:h-screen h-[50%] flex flex-col justify-between '>
                    <div className='p-10'>
                        ...
                        <p className='font-extralight mt-10'>Use solar energy to power your home and reduce your dependence on the grid. Purchase solar at the lowest price of any national provider with Earth Energy price match guarantee and take control of your monthly electricity bill.</p>
                    </div>
