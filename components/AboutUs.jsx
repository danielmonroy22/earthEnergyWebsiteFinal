...
const AboutUs = () => {
    return (
        <div id='about' className='  min-h-[50vh] bg-cover bg-center bg-no-repeat md:bg-cover' style={{ backgroundImage: 'url("../assets/AboutUs5.jpg")' }}>
            <div className='min-h-[50vh] text-center z-0 bg-[#00000080]  '>
