...
const AboutUs = () => {
    return (
        <div className='md:min-h-[100vh] min-h-screen w-full  bg-cover bg-center bg-no-repeat md:bg-cover   ' style={{ backgroundImage: "url('../assets/HomePage7.jpg')" }} >
            <div id='about' className=' rounded-xl md:px-20 bg-[#00000080]  min-h-[100vh]  flex justify-center items-center'  >
