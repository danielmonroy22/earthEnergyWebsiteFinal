            ...
            <div className='bg-[#00000080] w-full h-full align-bottom opacity '  >
                ...
                <div className='h-[85%] flex items-center flex-col justify-between '>
                    ...
                    <div className='flex flex-col gap-10 text-white md:gap-10 md:flex-row  '>
                        ...
                        <div className=' w-auto px-14 md:px-0  h-28 gap-7  flex justify-center items-center mt-5 md:mt-0' >

                            <div className='  md:w-[24%] w-[16%] md:h-[100px] cursor-pointer'>
                            ...
                            <div className=' md:h-[100px] md:w-[24%]  w-[16%] cursor-pointer'>
