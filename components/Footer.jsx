        ...
        <div class="w-full min-h-[40vh] flex items-center justify-center bg-black p-10">
            <div class="md:w-2/3 w-full px-4 text-white flex flex-col ">
                ...
                <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p class="w-full md:w-2/3 text-gray-400">Going green has never been easier, with our team of experts ready to guide you through the process of switching to solar. Contact us today and start saving money while you save the planet.</p>
                    <div class="w-44 pt-6 md:pt-0">
                        <Link href='/#contact' onClick={handleClick} className="bg-blue-400 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center" >
                            {/* <button class="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact US</button> */}
                            Contact Us
                ...
                <div class="flex flex-col">
                    <div class="flex mt-24 mb-12 flex-row justify-between">
                        ...
                        <div className="flex gap-5 justify-center items-center">
                            ...
                            <Link href='#residential' className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase' onClick={handleClick}>residential</Link>
                            <Link href='#commercial' className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase' onClick={handleClick}>Commercial</Link>
                            <Link href='#about' className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase' onClick={handleClick}>about us</Link>
                            <Link href='#contact' className='hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase' onClick={handleClick}>Contact us</Link>
